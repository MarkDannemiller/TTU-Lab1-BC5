...
module I2C_COMMS (
    ...
    reg drive_low=0; //test bench register to see when serial data is driven low
    ...
    always @(posedge SCL_negedge) begin
        ...
        if ((bitcount == 8) | ((bitcount == (currRead+1)*8 + currRead) & ~rw) & (addressmatch))
        ...
        //Data write
        else if ((bitcount >= 9) & (rw) & (addressmatch) & (write_byte < SEND_BYTES))
        begin
            //Send Data  
